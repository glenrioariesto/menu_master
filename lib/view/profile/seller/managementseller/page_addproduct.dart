...
class ManagementAddProduct extends StatefulWidget {
  const ManagementAddProduct({super.key});

  @override
  State<ManagementAddProduct> createState() => _ManagementAddProductState();
}

class _ManagementAddProductState extends State<ManagementAddProduct> {
